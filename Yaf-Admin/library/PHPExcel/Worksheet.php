...
class Worksheet implements IComparable {
            ...
            foreach ( $this->getCellCollection(false) as $cellID ) {
                ...
                if ($cell !== null && isset($autoSizes[$this->cellCollection->getCurrentColumn()])) {
                    ...
                    if (!isset($isMergeCell[$this->cellCollection->getCurrentAddress()])) {
                        ...
                        $autoSizes[$this->cellCollection->getCurrentColumn()] = max((float) $autoSizes[$this->cellCollection->getCurrentColumn()], (float) Shared\Font::calculateColumnWidth($this->getParent()->getCellXfByIndex($cell->getXfIndex())->getFont(), $cellValue, $this->getParent()->getCellXfByIndex($cell->getXfIndex())->getAlignment()->getTextRotation(), $this->getDefaultStyle()->getFont()));
                    }
                }
            }
     ...
     * Please note that this will overwrite existing cell styles for cells in range!
     *
     * @param Style\Conditional[] $pCellStyle
     *            Cell style to duplicate
     * @param string $pRange
     *            Range of cells (i.e. "A1:B10"), or just one cell (i.e. "A1")
     * @throws Exception
     ...
     *            Break type (type of \PHPExcel\Worksheet::BREAK_*)
     * @return Worksheet
     */
    ...
    public function setAutoFilterByColumnAndRow($pColumn1 = 0, $pRow1 = 1, $pColumn2 = 0, $pRow2 = 1) {
        return $this->setAutoFilter(Cell::stringFromColumnIndex($pColumn1) . $pRow1 . ':' . Cell::stringFromColumnIndex($pColumn2) . $pRow2);
    }
