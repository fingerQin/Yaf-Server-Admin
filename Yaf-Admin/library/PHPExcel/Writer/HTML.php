...
class HTML extends BaseWriter implements IWriter {
     ...
     *
     * @param \PHPExcel\Style\Alignment $pStyle
     ...
     *
     * @param \PHPExcel\Style\Font $pStyle
     *            \PHPExcel\Style\Font
     * @return array
     */
     ...
     *
     * @param \PHPExcel\Style\Borders $pStyle
     ...
     *
     * @param \PHPExcel\Style\Border $pStyle
     ...
     *
     * @param \PHPExcel\Style\Fill $pStyle
     *            \PHPExcel\Style\Fill
     * @return array
     */
                ...
                if ($cell instanceof \PHPExcel\Cell) {
                    ...
                    if ($cell->getValue() instanceof \PHPExcel\RichText) {
                        ...
                        if ($this->preCalculateFormulas) {
                            $cellData = \PHPExcel\Style\NumberFormat::toFormattedString($cell->getCalculatedValue(), $pSheet->getParent()->getCellXfByIndex($cell->getXfIndex())->getNumberFormat()->getFormatCode(), array(
                            $this,
                            'formatColor' 
                            ));
                        } else {
                            $cellData = \PHPExcel\Style\NumberFormat::toFormattedString($cell->getValue(), $pSheet->getParent()->getCellXfByIndex($cell->getXfIndex())->getNumberFormat()->getFormatCode(), array(
                            $this,
                            'formatColor' 
                            ));
                        }
                    ...
                    if (!$this->useInlineCss) {
                        ...
                        if ($sharedStyle->getAlignment()->getHorizontal() == \PHPExcel\Style\Alignment::HORIZONTAL_GENERAL && isset($this->cssStyles['.' . $cell->getDataType()]['text-align'])) {
