...
class DateTime {
    ...
    public static function DATEVALUE($dateValue = 1) {
        ...
        if (($PHPDateArray !== false) && ($PHPDateArray['error_count'] == 0)) {
            ...
            $excelDateValue = floor(\PHPExcel\Shared\Date::formattedPHPToExcel($PHPDateArray['year'], $PHPDateArray['month'], $PHPDateArray['day'], $PHPDateArray['hour'], $PHPDateArray['minute'], $PHPDateArray['second']));
            switch (Functions::getReturnDateType()) {
                case Functions::RETURNDATE_EXCEL :
                    return (float) $excelDateValue;
                case Functions::RETURNDATE_PHP_NUMERIC :
    ...
    public static function TIMEVALUE($timeValue) {
        ...
        if (($PHPDateArray !== false) && ($PHPDateArray['error_count'] == 0)) {
            if (Functions::getCompatibilityMode() == Functions::COMPATIBILITY_OPENOFFICE) {
                $excelDateValue = \PHPExcel\Shared\Date::formattedPHPToExcel($PHPDateArray['year'], $PHPDateArray['month'], $PHPDateArray['day'], $PHPDateArray['hour'], $PHPDateArray['minute'], $PHPDateArray['second']);
            } else {
