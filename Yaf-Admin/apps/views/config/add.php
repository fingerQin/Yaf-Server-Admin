		...
		<table cellpadding="2" cellspacing="1" class="content" width="100%">
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="title" id="title" size="20" class="input-text" value="">
				...
				<tr>
					...
					<td>
						<input type="text" name="cfg_key" id="cfg_key" size="20" class="input-text" value="">
						<div class="w90" style="color:grey;">（字母、数字、下划线组成）</div>
					</td>
				</tr>
				<tr>
					<th class="left-txt">配置值：</th>
					<td><textarea name="cfg_value" id="cfg_value" class="textarea" rows="3" cols="50"></textarea></td>
				</tr>
				<tr>
					<th class="left-txt">描述：</th>
					<td><textarea name="description" id="description" class="textarea" rows="3" cols="50"></textarea></td>
				</tr>
				<tr>
					<td></td>
					<td>
