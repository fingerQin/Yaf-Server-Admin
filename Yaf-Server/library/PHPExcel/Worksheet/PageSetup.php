...
class PageSetup {
    ...
    public function setPrintAreaByColumnAndRow($column1, $row1, $column2, $row2, $index = 0, $method = self::SETPRINTRANGE_OVERWRITE) {
        return $this->setPrintArea(\PHPExcel\Cell::stringFromColumnIndex($column1) . $row1 . ':' . \PHPExcel\Cell::stringFromColumnIndex($column2) . $row2, $index, $method);
    }
    ...
    public function addPrintAreaByColumnAndRow($column1, $row1, $column2, $row2, $index = -1) {
        return $this->setPrintArea(\PHPExcel\Cell::stringFromColumnIndex($column1) . $row1 . ':' . \PHPExcel\Cell::stringFromColumnIndex($column2) . $row2, $index, self::SETPRINTRANGE_INSERT);
    }
