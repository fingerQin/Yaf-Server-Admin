...
class ColumnIterator implements \Iterator {
    ...
    public function prev() {
        if ($this->position <= $this->startColumn) {
            throw new \PHPExcel\Exception("Column is already at the beginning of range (" . \PHPExcel\Cell::stringFromColumnIndex($this->endColumn) . " - " . \PHPExcel\Cell::stringFromColumnIndex($this->endColumn) . ")");
        }
