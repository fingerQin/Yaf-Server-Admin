...
class Style extends WriterPart {
     ...
     *            XML Writer
     * @param \PHPExcel\Style\Fill $pFill
     *            Fill style
     * @throws \PHPExcel\Writer\Exception
     */
    private function writeFill(\PHPExcel\Shared\XMLWriter $objWriter = null, \PHPExcel\Style\Fill $pFill = null) {
        // Check if this is a pattern type or gradient type
        if ($pFill->getFillType() === \PHPExcel\Style\Fill::FILL_GRADIENT_LINEAR || $pFill->getFillType() === \PHPExcel\Style\Fill::FILL_GRADIENT_PATH) {
            // Gradient fill
     ...
     * @param \PHPExcel\Shared\XMLWriter $objWriter
     *            XML Writer
     * @param \PHPExcel\Style\Font $pFont
     *            Font style
     * @throws \PHPExcel\Writer\Exception
     */
     ...
     * @param \PHPExcel\Shared\XMLWriter $objWriter
     *            XML Writer
     * @param \PHPExcel\Style\Borders $pBorders
     *            Borders style
     * @throws \PHPExcel\Writer\Exception
     */
     ...
     * @param string $pName
     *            Element name
     * @param \PHPExcel\Style\Border $pBorder
     *            Border style
     * @throws \PHPExcel\Writer\Exception
     */
     ...
     * @param \PHPExcel\Shared\XMLWriter $objWriter
     *            XML Writer
     * @param \PHPExcel\Style\NumberFormat $pNumberFormat
     *            Number Format
     * @param int $pId
