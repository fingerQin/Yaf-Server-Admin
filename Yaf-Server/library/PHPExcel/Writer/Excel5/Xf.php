...
class Xf {
    ...
    public function writeXf() {
        ...
        $diag_tl_to_rb = $diagonalDirection == \PHPExcel\Style\Borders::DIAGONAL_BOTH || $diagonalDirection == \PHPExcel\Style\Borders::DIAGONAL_DOWN;
        $diag_tr_to_lb = $diagonalDirection == \PHPExcel\Style\Borders::DIAGONAL_BOTH || $diagonalDirection == \PHPExcel\Style\Borders::DIAGONAL_UP;
    ...
    \PHPExcel\Style\Fill::FILL_GRADIENT_PATH => 0x00 
