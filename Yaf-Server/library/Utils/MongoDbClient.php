...
class MongoDbClient
{
    ...
    {
        $user = YCore::appconfig('mongodb.default.user');
        $port = YCore::appconfig('mongodb.default.port');
        $host = YCore::appconfig('mongodb.default.host');
        $pass = YCore::appconfig('mongodb.default.pass');
